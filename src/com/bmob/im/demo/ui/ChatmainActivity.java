...
public class ChatmainActivity extends ActivityBase implements EventListener{
	...
	private void refreshInvite(BmobInvitation message){
		...
		if(currentTabIndex==1){
			...
			BmobNotifyManager.getInstance(this).showNotify(isAllow,isAllowVibrate,R.drawable.ic, tickerText, message.getFromname(), tickerText.toString(),NewFriendActivity.class);
		}
	}
